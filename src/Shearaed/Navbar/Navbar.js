...
const Navbar = () => {
    ...
    const menuItems = <React.Fragment>
        ...
        <li className='text-lime-200'><div className="form-control">
            <div className="input-group">
                <select className="select select-bordered">
                    <option disabled selected>Pick category</option>
                    <Link to="/mirpur"> <option>Mirpur</option></Link>
                    <option>Mugs</option>
                </select>
        ...
        <li className='text-lime-200'><Link to="/mirpur">Mirpur</Link></li>
        {
            user?.uid ?
                <>
    ...
    return (
        ...
        // <div className='fixed bg-stone-800 shadow-md  z-50 w-full px-5 py-2 flex justify-between items-center'>
        ...
        //                 <span></span><img className='h-6 w-6 mt-3 ml-3 mr-0 pr-0 rounded-sm' src="https://i.ibb.co/yhfvGNc/favicon-2.jpg" alt="" /> <span className="btn btn-ghost normal-case text-2xl animate-charcter">Garage Theatre</span> </Link>
        //         </div>
