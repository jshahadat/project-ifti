...
const Television = () => {
    return (
        <div>
            <div className='pb-28' style={{ backgroundImage: "url(https://i.ibb.co/fS7V7tD/service-worker-installing-tv-set-274689-13147.jpg)", backgroundPosition: "center", backgroundSize: "cover" }}>
                {/* <img src="https://i.ibb.co/NCQDzwT/male-electrician-works-switchboard-with-electrical-connecting-cable.jpg" alt="" /> */}
                <h1 className='text-white text-4xl font-extrabold pt-28 pl-28 pb-12'>Best Television Service Near You</h1>
