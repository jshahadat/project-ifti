...
const Carpenter = () => {
    return (
        <div>
            <div className='pb-28' style={{ backgroundImage: "url(https://i.ibb.co/zQK5ZP2/carpenter-working-with-equipment-wooden-table-carpentry-shop-woman-works-carpentry-shop-1418-2505.jpg)", backgroundPosition: "center", backgroundSize: "cover" }}>
                {/* <img src="https://i.ibb.co/NCQDzwT/male-electrician-works-switchboard-with-electrical-connecting-cable.jpg" alt="" /> */}
                <h1 className='text-white text-4xl font-extrabold pt-28 pl-28 pb-12'>Best Carpenter Service Near You</h1>
