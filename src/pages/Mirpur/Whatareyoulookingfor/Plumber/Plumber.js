...
const Plumber = () => {
    return (
        <div>
            <div className='pb-28' style={{ backgroundImage: "url(https://i.ibb.co/2Skkv8t/plumber-repair-experienced-attentive-middleaged-man-examining-bottom-kitchen-sink.jpg)", backgroundPosition: "center", backgroundSize: "cover" }}>
                {/* <img src="https://i.ibb.co/NCQDzwT/male-electrician-works-switchboard-with-electrical-connecting-cable.jpg" alt="" /> */}
                <h1 className='text-white text-4xl font-extrabold pt-28 pl-28 pb-12'>Best Plumber Service Near You</h1>
